...
const TIPS=[
  ...
  {cat:'mul',title:{en:'Difference of squares',nl:'Verschil van kwadraten',es:'Diferencia de cuadrados'},
   body:{en:'a² − b² = (a+b)(a−b). Great for multiplying numbers equidistant from a round figure.',nl:'a² − b² = (a+b)(a−b). Handig voor getallen even ver van een rond getal.',es:'a² − b² = (a+b)(a−b). Ideal para multiplicar números equidistantes de una cifra redonda.'},
  ...
  {cat:'mul',title:{en:'Multiply two numbers near 100',nl:'Twee getallen dicht bij 100 vermenigvuldigen',es:'Multiplicar dos números cercanos a 100'},
   ...
   ops:['mul']},
  {cat:'mul',title:{en:'Double and halve',nl:'Verdubbelen en halveren',es:'Doblar y dividir'},
   body:{en:'Double one number and halve the other so that one becomes a round number. Works best when one number is an even number and the other ends in 5.',nl:'Verdubbel één getal en halveer het andere zodat één ervan een rond getal wordt. Werkt het beste als één getal even is en het andere eindigt op 5.',es:'Dobla un número y divide el otro por la mitad para que uno se convierta en un número redondo. Funciona mejor cuando uno es un número par y el otro termina en 5.'},
   ex:{en:'<span class="step">Example:</span>  <span class="hl">12 × 15</span>\n→ halve 12 = 6, double 15 = 30\n→ 6 × 30 = <span class="hl">180</span>',nl:'<span class="step">Voorbeeld:</span>  <span class="hl">12 × 15</span>\n→ halveer 12 = 6, verdubbel 15 = 30\n→ 6 × 30 = <span class="hl">180</span>',es:'<span class="step">Ejemplo:</span>  <span class="hl">12 × 15</span>\n→ mitad de 12 = 6, dobla 15 = 30\n→ 6 × 30 = <span class="hl">180</span>'},
   ops:['mul']},
