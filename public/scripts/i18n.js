...
en:{
 ...
 mode_lightning:"Lightning",mode_speed:"Speed",mode_daily:"Daily Challenge",mode_practice:"Practice",mode_campaign:"Campaign",
  ...
  mode_circuit_desc:"Trace paths · 4 targets",
  circuit_setup_sub:"Drag through adjacent numbers and symbols. Find a path for all 4 targets — left to right, no repeats, no diagonals.",
  circuit_hint:"Hint",
  circuit_targets_label: 'Solved',
  circuit_result_title:"Circuit Complete!",
  circuit_targets_section_label:"Targets",
  circuit_result_sub:"Come back tomorrow for a new puzzle.",
  circuit_share_msg:"I completed today's Numfly Circuit in {time}! Can you beat it? 🔀",
  circuit_result_sub:"Share your time and challenge your friends 👇",
  campaign_new_levels:"NEW LEVELS",
  mode_campaign_desc:"120 levels of increasing difficulty. Complete them one by one.",
  campaign_hero_sub:"Complete all 120 levels. Each level unlocks the next.",campaign_no_calc:"For best results, try to solve these without a calculator.",
  ...
  campaign_world_1:"World 1 — Basics",campaign_world_2:"World 2 — Multiplication",campaign_world_3:"World 3 — Speed",campaign_world_4:"World 4 — Percentages",campaign_world_5:"World 5 — Medium Crunch",campaign_world_6:"World 6 — Hard Numbers",campaign_world_7:"World 7 — Hard Mixed",campaign_world_8:"World 8 — Endurance",campaign_world_9:"World 9 — Elite",campaign_world_10:"World 10 — Master",campaign_world_11:"World 11 — Legend",campaign_world_12:"World 12 — Apex",
...
leaderboard_sub:"Friends + global top 10",lb_sign_in_msg:"Sign in to see the leaderboard",lb_group_general:"General",lb_group_speed:"Speed",lb_group_lightning:"Lightning",lb_tab_streak:"Daily Streak",lb_tab_turbo_streak:"Turbo Streak",lb_tab_circuit_streak:"Circuit Streak",
  ...
  friend_not_found:"No user found for '{q}'",
  friend_add:"+ Add",
  friend_already:"✓ Friends",
  friend_pending_btn:"⏳ Pending",
  friend_request_sent:"Request sent to {name}!",
  friend_wants_friend:"wants to be friends",
  friend_accept:"✓ Accept",
  friend_decline:"✗ Decline",
  friend_block:"🚫 Block",
  err_search:"Search error. Try again.",
  err_load_friends:"Error loading friends.",
  err_load_scoreboard:"Error loading scoreboard.",
  err_challenge_not_found:"Challenge not found.",
  stats_no_data:"no data",
  lb_no_friends:"Add friends to see how you compare! 👥",
  ...
  ach_lightning_seq_3_name:"Thunderbolt",ach_lightning_seq_3_desc:"Answer a sequence of 15 on Medium",
  ach_lightning_seq_4_name:"Lightning God",ach_lightning_seq_4_desc:"Answer a sequence of 20 on Hard",
  ach_lightning_streak_1_name:"Consistent",ach_lightning_streak_1_desc:"Get 3 correct answers in a row",
  ach_lightning_streak_2_name:"On Fire",ach_lightning_streak_2_desc:"Get 10 correct answers in a row",
  ach_lightning_streak_3_name:"Flawless",ach_lightning_streak_3_desc:"Get 25 correct answers in a row",
  ...
  ach_level_7_name:"Level 200",ach_level_7_desc:"Reach Level 200",
  ach_level_8_name:"Level 300",ach_level_8_desc:"Reach Level 300",
  ach_level_9_name:"Level 500",ach_level_9_desc:"Reach Level 500 — halfway to the top",
  ...
  ach_cmp_100_name:"Grand Master",ach_cmp_100_desc:"Complete the first 100 campaign levels",
  ach_cmp_120_name:"Apex Legend",ach_cmp_120_desc:"Complete all 120 campaign levels",
  ...
  ach_daily_speed_1_name:"Quick",ach_daily_speed_1_desc:"Complete Turbo in under 30 seconds",
  ach_daily_speed_2_name:"Lightning",ach_daily_speed_2_desc:"Complete the Turbo in under 25 seconds",
  ach_daily_speed_3_name:"Flash",ach_daily_speed_3_desc:"Complete Turbo in under 20 seconds",
  ach_circuit_speed_1_name:"Trailblazer",ach_circuit_speed_1_desc:"Complete Circuit in under 30 seconds",
  ach_circuit_speed_2_name:"Speedwire",ach_circuit_speed_2_desc:"Complete Circuit in under 15 seconds",
  ach_circuit_speed_3_name:"Overclock",ach_circuit_speed_3_desc:"Complete Circuit in under 5 seconds",
  ach_lightning_score_1_name:"Point Scorer",ach_lightning_score_1_desc:"Reach a Lightning score of 500 (any difficulty)",
  ach_lightning_score_2_name:"High Voltage",ach_lightning_score_2_desc:"Reach a Lightning score of 2,000 (any difficulty)",
  ach_lightning_score_3_name:"Overload",ach_lightning_score_3_desc:"Reach a Lightning score of 5,000 (any difficulty)",
  ach_lightning_score_4_name:"Megawatt",ach_lightning_score_4_desc:"Reach a Lightning score of 15,000 (any difficulty)",
  ...
  daily_title:"Turbo",daily_resets_in_hm:"New challenge in {h}h {m}m",daily_resets_in_m:"New challenge in {m}m",
  circuit_card_title:"Circuit",
...
nl:{
  ...
  mode_circuit_desc:"Trek paden · 4 doelen",
  circuit_setup_sub:"Sleep langs aangrenzende getallen en symbolen. Vind een pad voor alle 4 doelen — van links naar rechts, geen herhalingen, geen diagonalen.",
  circuit_hint:"Hint",
  circuit_targets_label:"Opgelost",
  circuit_card_title:"Circuit",
  circuit_targets_section_label:"Doelen",
  circuit_share_msg:"Ik heb het Numfly Circuit van vandaag gehaald in {time}! Kun jij het verslaan? 🔀",
  circuit_result_sub:"Deel je tijd en daag je vrienden uit 👇",
  campaign_new_levels:"NIEUWE LEVELS",
  ...
  mode_campaign_desc:"120 niveaus van toenemende moeilijkheid. Voltooi ze één voor één.",
  campaign_hero_sub:"Voltooi alle 120 niveaus. Elk niveau ontgrendelt het volgende.",campaign_no_calc:"Je leert er het meest van als je het zonder rekenmachine probeert.",
  ...
  ach_lightning_seq_3_name:"Donderslag",ach_lightning_seq_3_desc:"Beantwoord een reeks van 15 op Gemiddeld",
  ach_lightning_seq_4_name:"Bliksemgod",ach_lightning_seq_4_desc:"Beantwoord een reeks van 20 op Moeilijk",
  ach_lightning_streak_1_name:"Consequent",ach_lightning_streak_1_desc:"Beantwoord 3 vragen correct op rij",
  ach_lightning_streak_2_name:"In Vuur en Vlam",ach_lightning_streak_2_desc:"Beantwoord 10 vragen correct op rij",
  ach_lightning_streak_3_name:"Foutloos",ach_lightning_streak_3_desc:"Beantwoord 25 vragen correct op rij",
  ...
  ach_level_7_name:"Niveau 200",ach_level_7_desc:"Bereik Niveau 200",
  ach_level_8_name:"Niveau 300",ach_level_8_desc:"Bereik Niveau 300",
  ach_level_9_name:"Niveau 500",ach_level_9_desc:"Bereik Niveau 500 — halverwege de top",
  ...
  ach_cmp_100_name:"Grootmeester",ach_cmp_100_desc:"Voltooi de eerste 100 campagneniveaus",
ach_cmp_120_name:"Apex Legende",ach_cmp_120_desc:"Voltooi alle 120 campagneniveaus",
  ...
  ach_daily_speed_1_name:"Snel",ach_daily_speed_1_desc:"Voltooi Turbo in onder 30 seconden",
  ach_daily_speed_2_name:"Bliksem",ach_daily_speed_2_desc:"Voltooi Turbo in onder 25 seconden",
  ach_daily_speed_3_name:"Flash",ach_daily_speed_3_desc:"Voltooi Turbo in onder 20 seconden",
  ach_circuit_speed_1_name:"Trailblazer",ach_circuit_speed_1_desc:"Voltooi Circuit in minder dan 30 seconden",
  ach_circuit_speed_2_name:"Speedwire",ach_circuit_speed_2_desc:"Voltooi Circuit in minder dan 15 seconden",
  ach_circuit_speed_3_name:"Overclock",ach_circuit_speed_3_desc:"Voltooi Circuit in minder dan 5 seconden",
  ach_lightning_score_1_name:"Puntenscoorder",ach_lightning_score_1_desc:"Bereik een Lightning score van 500 (elke moeilijkheidsgraad)",
  ach_lightning_score_2_name:"Hoogspanning",ach_lightning_score_2_desc:"Bereik een Lightning score van 2.000 (elke moeilijkheidsgraad)",
  ach_lightning_score_3_name:"Overbelasting",ach_lightning_score_3_desc:"Bereik een Lightning score van 5.000 (elke moeilijkheidsgraad)",
  ach_lightning_score_4_name:"Megawatt",ach_lightning_score_4_desc:"Bereik een Lightning score van 15.000 (elke moeilijkheidsgraad)",
  ...
  daily_title:"Turbo",daily_resets_in_hm:"Nieuw uitdaging in {h}u {m}m",daily_resets_in_m:"Nieuw uitdaging in {m}m",
...
es:{
  ...
  mode_circuit_desc:"Traza caminos · 4 objetivos",
  circuit_setup_sub:"Arrastra por números y símbolos adyacentes. Encuentra un camino para los 4 objetivos — de izquierda a derecha, sin repetir, sin diagonales.",
  circuit_hint:"Pista",
  circuit_targets_label:"Resueltos",
  circuit_card_title:"Circuito",
  circuit_targets_section_label:"Objetivos",
  circuit_share_msg:"He completado el Circuit de Numfly hoy en {time}! ¿Puedes superarlo? 🔀",
  circuit_result_sub:"Comparte tu tiempo y desafía a tus amigos 👇",
  campaign_new_levels:"NIVELES NUEVOS",
  ...
  mode_campaign_desc:"120 niveles de dificultad creciente. Supéralos uno a uno.",
  campaign_hero_sub:"Completa los 120 niveles. Cada nivel desbloquea el siguiente.",campaign_no_calc:"Para mejores resultados, intenta resolverlos sin calculadora.",
  ...
  ach_lightning_seq_3_name:"Rayo",ach_lightning_seq_3_desc:"Responde una secuencia de 15 en Medio",
  ach_lightning_seq_4_name:"Dios del Rayo",ach_lightning_seq_4_desc:"Responde una secuencia de 20 en Difícil",
  ach_lightning_streak_1_name:"Consistente",ach_lightning_streak_1_desc:"Responde 3 respuestas de Rayo seguidas correctamente",
  ach_lightning_streak_2_name:"En Llamas",ach_lightning_streak_2_desc:"Responde 10 respuestas de Rayo seguidas correctamente",
  ach_lightning_streak_3_name:"Impecable",ach_lightning_streak_3_desc:"Responde 25 respuestas de Rayo seguidas correctamente",
  ...
  ach_level_7_name:"Nivel 200",ach_level_7_desc:"Alcanza el Nivel 200",
  ach_level_8_name:"Nivel 300",ach_level_8_desc:"Alcanza el Nivel 300",
  ach_level_9_name:"Nivel 500",ach_level_9_desc:"Alcanza el Nivel 500 — a mitad de camino",
  ...
  ach_cmp_100_name:"Gran Maestro",ach_cmp_100_desc:"Completa los primeros 100 niveles de campaña",
  ach_cmp_120_name:"Leyenda Apex",ach_cmp_120_desc:"Completa los 120 niveles de campaña",
  ...
  ach_daily_speed_1_name:"Rápido",ach_daily_speed_1_desc:"Completa Turbo en menos de 30 segundos",
  ach_daily_speed_2_name:"Rayo",ach_daily_speed_2_desc:"Completa Turbo en menos de 25 segundos",
  ach_daily_speed_3_name:"Flash",ach_daily_speed_3_desc:"Completa Turbo en menos de 20 segundos",
  ach_circuit_speed_1_name:"Trailblazer",ach_circuit_speed_1_desc:"Completa Circuit en menos de 30 segundos",
  ach_circuit_speed_2_name:"Speedwire",ach_circuit_speed_2_desc:"Completa Circuit en menos de 15 segundos",
  ach_circuit_speed_3_name:"Overclock",ach_circuit_speed_3_desc:"Completa Circuit en menos de 5 segundos",
  ach_lightning_score_1_name:"Anotador",ach_lightning_score_1_desc:"Alcanza una puntuación en Lightning de 500 (cualquier dificultad)",
  ach_lightning_score_2_name:"Alta Tensión",ach_lightning_score_2_desc:"Alcanza una puntuación en Lightning de 2.000 (cualquier dificultad)",
  ach_lightning_score_3_name:"Sobrecarga",ach_lightning_score_3_desc:"Alcanza una puntuación en Lightning de 5.000 (cualquier dificultad)",
  ach_lightning_score_4_name:"Megavatio",ach_lightning_score_4_desc:"Alcanza una puntuación en Lightning de 15.000 (cualquier dificultad)",
  ...
  daily_title:"Turbo",daily_resets_in_hm:"Nuevo desafío en {h}h {m}m",daily_resets_in_m:"Nuevo desafío en {m}m",
  circuit_card_title:"Circuito",
...
if (typeof window !== 'undefined') {
  ...
  let p = basePath;
  if (lang === 'nl') {
    const dictNl = { '/friends':'/vrienden', '/stats':'/statistieken', '/leaderboard':'/klassement', '/achievements':'/prestaties', '/tips':'/tips', '/campaign':'/campagne', '/daily':'/turbo', '/turbo':'/turbo', '/lightning':'/bliksem', '/speed':'/snelheid', '/practice':'/oefenen', '/1v1':'/1v1', '/how-to-practice-mental-math':'/hoofdrekenen-oefenen', '/circuit':'/circuit' };
    p = '/nl' + (dictNl[basePath] || basePath);
  } else if (lang === 'es') {
    const dictEs = { '/friends':'/amigos', '/stats':'/estadisticas', '/leaderboard':'/clasificacion', '/logros':'/achievements', '/tips':'/consejos', '/campaign':'/campana', '/daily':'/turbo', '/turbo':'/turbo', '/lightning':'/rayo', '/speed':'/velocidad', '/practice':'/practica', '/1v1':'/1v1', '/how-to-practice-mental-math':'/como-practicar-calculo-mental', '/circuit':'/circuito' };
